                    ...
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            ...
                            <form class="form-signin" action="{{ route('login') }}" method="POST">
                                ...
                                <?php $today = Date('Y-m-d'); $msg = ""; ?>
                                @if($today > $license)
                                <?php $msg = "Votre license a expiré le ".$license; ?>
                                <button disabled class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Se connecter</button>
                                @else
                                    @if(date('Y-m-d', strtotime($today. ' + 15 days')) > $license)
                                    <?php $msg = "Votre license va bientot expiré le ".$license; ?>
                                    @endif
