	          ...
	          <div class="form quick-post">
	            ...
	            <form class="form-horizontal" autocomplete="off" dir="ltr" action="/add_op_ar" method="POST">
				  ...
				  <div class="form-group ">
	                ...
	                <div class="col-lg-9">
	                  <input required="" placeholder="0000" onkeyup="change_num()" dir="ltr" style="text-align : left" value="" type="text" class="form-control" id="activite" name="activite">
	                </div>
	              </div><br>
				  <div class="form-group">
				  	<label readonly class="control-label col-lg-3" style="text-align : left;" for="title">Sous-action</label>
	                <div class="col-lg-9">
	                  <input  placeholder="000" onkeyup="change_num()" dir="ltr" style="text-align : left" value="" type="text" class="form-control" id="sous_action" name="sous_action">
	                </div>
	              </div><br>
				  <div class="form-group ">
