	...
	<div class="col-lg-8 portlets" >
	    <div class="panel panel-default">
	      <div class="panel-heading">
	        <div class="pull-left"><h3> Modifier Opération</h3> </div>
	        <br><br>
	      </div>
	      <div class="panel-body">
	        <div class="padd">
	          ...
	          <div class="form quick-post">
	            ...
	            <form class="form-horizontal" autocomplete="off" dir="ltr" action="/update_op_ar" method="POST">
				  ...
				  <div class="form-group">
	                ...
	                <div class="col-lg-9">
	                	<select onchange="get_progs(this.value)" id="portefeuille" name="portefeuille" class="form-control">
							<option selected style="visibility :  hidden" value="{{$p->code}}">{{$p->code}} - {{$p->ministere_fr}}</option>
				  ...
				  <div class="form-group">
	                ...
	                <div class="col-lg-9">
	                	<select onchange="get_sous(this.value)" name="programme" id="programme" class="form-control">
                            <option selected style="visibility :  hidden" value="{{$prog->code}}">{{$prog->code}} - {{$prog->designation_fr}}</option>
							@foreach($programmes as $programme)
								<option value="{{$programme->code}}">{{$programme->code}} - {{$programme->designation_fr}}</option>
							@endforeach
						</select>  
					</div>
	              </div><br>
				  <div class="form-group">
	                ...
	                <div class="col-lg-9">
	                	<select onchange="sous(this.value)" name="sous_programme" id="sous_programme" class="form-control">
							@if(isset($sous->code))
								<option selected style="visibility :  hidden" value="{{$sous->id}}*1989raouf1989*{{$sous->code}}">{{$sous->code}} - {{$sous->designation_fr}}</option>
							@else
								<option selected style="visibility :  hidden" value="NULL"></option>
							@endif
                            @foreach($sous_ps as $sous_p)
								<option value="{{$sous_p->id}}*1989raouf1989*{{$sous_p->code}}">{{$sous_p->code}} - {{$sous_p->designation_fr}}</option>
							@endforeach
						</select>  
					</div>
	              </div><br>
				  <div class="form-group">
	                ...
	                <div class="col-lg-9">
	                  <input required="" value="{{$op->activite}}" onkeyup="change_num()" dir="ltr" style="text-align : left" value="" type="text" class="form-control" id="activite" name="activite">
	                </div>
	              </div><br>
				  <div class="form-group">
	              ...
	              <div class="form-group">
	                ...
	                <div class="col-lg-9">
	                  <input required="" dir="ltr" style="text-align : left" value="{{$op->numero}}" type="text" class="form-control" id="numero" name="numero">
	                </div>
	              </div><br>
	              <!-- Content -->
				  ...
				  <div class="form-group ">
	              	...
	              	<div class="col-lg-9">
	                  <input dir="ltr" style="text-align : left;" onkeyup="update_AP()" onchange="update_AP()" value="{{$op->AP_init}}" type="number" step="0.01" placeholder="0.00" class="form-control" id="AP_init" name="AP_init">
		            </div>
                  </div><br>

				  <div class="form-group ">
				  	<label readonly class="control-label col-lg-3" style="text-align : left;" for="content">  Réevaluation </label>
	              	<div class="col-lg-9">
	                  <input dir="ltr" style="text-align : left;" onkeyup="update_AP()"  onchange="update_AP()" value="{{$op->reevaluation}}" type="number" step="0.01" placeholder="0.00" class="form-control" id="reevaluation" name="reevaluation">
		            </div>
                  </div><br>

				  <div class="form-group ">
				  	<label readonly class="control-label col-lg-3" style="text-align : left;" for="content"> AE Actuelle </label>
	              	<div class="col-lg-9">
	                  <input dir="ltr" style="text-align : left;" value="{{$op->AP_act}}" type="number" step="0.01" placeholder="0.00" class="form-control" id="AP_act" name="AP_act">
		            </div>
                  </div><br>
				 
				  <div class="form-group ">
				  	<label  class="control-label col-lg-3" style="text-align : left;" for="content">  Décision de cloture</label>
	              	<div class="col-lg-9">
	                  <input   dir="ltr" type="text" value="{{$op->num_cloture}}" class="form-control" id="num_cloture" name="num_cloture">
		            </div>
                  </div><br>
				  <div class="form-group ">
				  	<label  class="control-label col-lg-3" style="text-align : left;" for="content"> Date de cloture</label>
	              	<div class="col-lg-9">
