				  ...
				  <table id="demo-table" class="table table-bordered personal-task resizable">
				    <tbody id="ops_place">
                        <tr style="  font-weight : bolder;">
                            ...
                            <td style=" width : 18%;"><div>  N° D'opération</div></td>
                            <td style=" width : 20%;"><div> Lot </div></td>
                            <td style=" width : 15%;"><div> Entreprise</div></td>
                            <td style=" width : 15%;"><div> Montant</div></td>
                            <td style=" width : 7%;"><div>N° Situation  </div></td>
                            <td style=" width : 8%;"><div> Date de situation </div></td>
                            <td style=" width : 7%;"><div> Visa</div></td>
                            <td style=" width : 8%;"><div>Date de paiement</div></td>
                        </tr>
                        ...
                        <tr style="font-weight : bold">
                            ...
                            <td>
                                ...
                                <span><h5><strong>{{$pay->travaux_type." ".$pay->travaux_num}}</strong></h5></span>
                                @else 
