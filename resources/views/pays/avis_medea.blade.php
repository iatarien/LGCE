...
$text = ucfirst($text);
$dir = mb_substr($direction, 1, null, 'UTF-8'); // removes the first character
?>
<section style="background-color: white; text-align: center; font-size: 14.5px; margin: 20px;" id="fiche" contenteditable="true">
	<div id="fiche_top">
		...
		<div style="float: right;  text-align : right; width : 100%;">
            <h3> تعيين الأمر بالصرف (1)<br>
			وزارة {{$ministere}} <br>
            مديرية {{$direction}} لولاية {{$ville}}<br>
             مسؤول النشاط غير الممركز ل{{$dir}} ولاية {{$ville}} : 
                {{$op->portefeuille}}.{{$op->programme}}.{{$sous_prog->code}}.{{$op->activite}} <br>

		</div>
        <div style="display : inline-block; width : 40%; marign-left : 30%" dir="ltr">
            <div class="boold">
                <h2 style="margin : 5px;">إشعار تحويل  </h2>
            </div>
        </div>
		<div align="right">
		...
		<div dir="rtl" style="float: right;  text-align : right; width : 100%;">
			...
			<br>
			<h3> تعيين الأمر بالتحويل، الهيئة <span> {{$direction}} لـــولاية <span> {{$ville}}   </h3>
            ...
            <h3>
            (01)	رأس الصفحة للأمر بالصرف ورمز النشاط المحتمل				<br>																
            (02)	حساب التعريف البنكي للخزينة اذا تعلق الامر بآمر بالصرف معتمد أو حساب التعريف البنكي للحائز على حساب تعريف الخزينة		<br>																		
            (03)	حساب التعريف البنكي للدائن				<br>																
    ...
    <br><br><br>
		<div align="center">
			...
			<span> <span style="">ختم الأمر بالتحويل</span>
