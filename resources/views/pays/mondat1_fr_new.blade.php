...
if($pay->deal_date != null){
    $txt=$txt." DU ".\Carbon\Carbon::parse($pay->deal_date)->format('d-m-Y')." ";
}
...
<section id="fiche">
	...
	<div style="float: left; width: 25%; margin-left: 5%;" id="top-right">
		...
		Date de Mandat : {{ \Carbon\Carbon::parse($pay->date_mondat)->format('d-m-Y') }} <br>
	...
	<br><br><br><span> Date de Réglement   </span>
	<br><br><br><br><br><span> Ordonnateur  </span>
	</div><br>
	<div dir="rtl" style="width: 40%; float : right; display: inline-block; font-size : 11px;">
		<br>
		<table id="bottom-left">
			<tr>
				<td colspan="2"> Cadre réservé au Comptable</td>
			</tr>
			<tr>
				<td></td>
		...
		<br>
		<span style="font-size : 14px;"> Comptable public assignataire </span><br>
	</div>
</section>
