...
<div id="main" class="row main">
	<div class="col-sm-12 portlets pull-right" lang="ar" dir="rtl" style="margin-right: 10%;"  >
	    <div class="panel panel-default">
	      ...
	      <div class="panel-body">
            ...
            <div class="form-group" align="center">
                    ...
                    <button type="button" onclick="borderau()" class="btn btn-success">إضافة</button>
                    </div>
                </div>
                <br><br>
	          <div class="form quick-post">
	            ...
	            <form class="form-horizontal" autocomplete="off" action="/update_borderau" method="POST">
                  ...
                  @csrf
                    <table id="" class="col-sm-12" dir="ltr">
                      <tbody id="engagement">
                        <tr>
                            <th>     حذف    </th>
                            <th>المبلغ  </th>
                        ...
                        @if($type =="eng")
                          ...
                          <td>
                              ...
                              <td style="widtd : 15%;">{{number_format((float)$eng->montant, 2, '.', ',')}} دج</td>
                        ...
                        @else
                          ...
                          <td>
                              <bouton onclick='suprimer("{{$eng->id_eng}}")' class='btn btn-danger'>X</button></td>
                              <td style="widtd : 15%;">{{number_format((float)$eng->to_pay, 2, '.', ',')}} دج</td>
                              <td style="widtd : 20%;">{{$eng->name}}</td>
