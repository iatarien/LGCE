...
function display(engagements,value){
	...
	var tds = '<tr style="  font-weight : bolder;">'+
		        ...
		        '<td style=" width : 20%;"><div> N° et intitule de l\'opération</div></td>'+
	...
	for (var i = 0; i < engagements.length; i++) {
		...
		'<tr style="font-weight : bold">'+
			...
			if(type == "retrait"){
				...
				tds +='<td>'+
		    	'<span><button class="btn btn-success"  onclick="document.location.href=\'/'+type+'/'+op[i].eng_id+'/{{$n}}\'">Selectionner</button></span>'+
		        '</td>';
			}else{
				tds +='<td>'+
		    	'<span><button class="btn btn-success"  onclick="document.location.href=\'/'+type+'/'+op[i].eng_id+'\'">Selectionner</button></span>'+
		        '</td>';
			}
