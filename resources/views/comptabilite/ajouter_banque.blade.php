	        ...
	        <div class="padd">
	          ...
	          <div class="form quick-post">
                ...
                <div class="form-group row">
	                ...
	                <div class="col-md-9">
	                  <input dir="rtl" style="text-align : right"  required type="text" class="form-control" id="nom" name="nom">
	                </div>
                </div>
                <br>
                <div class="form-group row">
	                ...
	                <div class="col-md-9">
	                  <input dir="ltr" style="text-align : right"  required type="text" class="form-control" id="abr" name="abr">
	                </div>
                </div>
                <br>
                <div class="form-group row">
	                ...
	                <div class="col-md-9">
	                  <input dir="rtl" style="text-align : right"  required type="text" class="form-control" id="nom" name="num">
	                </div>
                </div>
                <br>
                <div class="form-group row">
	                ...
	                <div class="col-md-9">
	                  <input dir="rtl" style="text-align : right"  required type="text" class="form-control" id="cle" name="cle">
	                </div>
                </div>
