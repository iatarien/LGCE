...
<div id="main" class="row main">
	...
	<div >
		...
		<section class="panel panel-info" style="display: table; width : 80%; float : right;" lang="ar" dir="rtl">
			<div class="panel-heading"> البنوك </div>
...
function display(es){
	...
	var tds = '<tr style="  font-weight : bolder;">'+
		        ...
		        '<td style="width : 40%;"><div>اسم البنك  </div></td>'+
				'<td style="width : 13%;"><div>  الرمز</div></td>'+
                '<td style="width : 13%;"><div>  الرقم</div></td>'+
                '<td style="width : 13%;"><div>  المفتاح</div></td>'+
		        '<td style="width : 16%;"><div>تعديل</div></td>'+
		      '</tr>';
	const op = es;
	for (var i = 0; i < es.length; i++) {
		...
		'<tr style="font-weight : bold">'+
            ...
            tds +='<td>'+
            '<span><button class="btn btn-primary"  onclick="document.location.href=\'/modifier_banque/'+op[i].id+'\'">تعديل</button></span>'+
            '</td>';
