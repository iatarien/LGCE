...
<div id="main" class="row main">
  <div align="center">
    <br>
    <a class="btn btn-primary" href="/ajouter_penalite"> إضافة  عقوبة تأخير </a>
    <br><br>
  </div>
	<div >
		<!--Project Activity start-->
		<section class="panel panel-info" style="display: table;" lang="ar" dir="rtl">
			<div class="panel-heading">  عقوبات التأخير</div>
				    ...
				    <tbody id="ops_place">
                        ...
                        @foreach($attestations as $att)
                          <tr>
                            ...
                            <td>{{$att->name}}</td>
                            <td>{{$att->lot}}</td>
                            <td><a href="/penalite1/{{$att->id_pen}}" class="btn btn-default">معاينة</a></td>
                            <td><a onclick="return confirm('هل أنت متأكد من أنك تريد الحذف ؟')" href="/delete_pen/{{$att->id_pen}}" class="btn btn-danger">حذف</a></td>
                        </tr>
                        @endforeach
				    </tbody>
				  </table>
