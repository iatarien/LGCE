	      ...
	      <div class="panel-body">
	        <div class="padd">
	          ...
	          <div class="form quick-post">
	            ...
	            <form class="form-horizontal" autocomplete="off" action="/insert_att" method="POST">
	            	@csrf
                ...
                <div class="form-group">
	                <div class="col-xs-10">
                        <textarea name="causes" rows="11" class="form-control" dir="rtl">{{$eng->name}} قد توقف</textarea>
                    </div>
