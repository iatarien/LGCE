...
<div id="main" class="row main">
  <div align="center">
    <br>
    <a class="btn btn-primary" href="/select_att/add_att"> إضافة شهادة إدارية </a>
    <br><br>
  </div>
	<div >
		<!--Project Activity start-->
		<section class="panel panel-info" style="display: table;" lang="ar" dir="rtl">
			<div class="panel-heading"> شهادات إدارية</div>
				    ...
				    <tbody id="ops_place">
                        ...
                        @foreach($attestations as $att)
                          <tr>
                            ...
                            <td>{{$att->name}}</td>
                            <td>{{$att->lot}}</td>
                            <td><a href="/att_admin/{{$att->id_att}}" class="btn btn-default">معاينة</a></td>
                            <td><a href="/edit_att/{{$att->id_att}}" class="btn btn-primary">تعديل</a></td>
                            <td><a onclick="return confirm('هل أنت متأكد من أنك تريد حذف هذه الشهادة ؟')" href="/delete_att/{{$att->id_att}}" class="btn btn-danger">حذف</a></td>
                        </tr>
                        @endforeach
				    </tbody>
				  </table>
