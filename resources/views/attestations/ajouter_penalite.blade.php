...
function display(engagements,value){
	...
	var tds = '<tr style="  font-weight : bolder;">'+
				...
				tds+='<td style="width : 8%; text-align : center;"><div>عقوبة تأخير</div></td>';
	...
	for (var i = 0; i < engagements.length; i++) {
		...
		'<tr style="font-weight : bold '+style+'">'+
			...
			if(op[i].pay_user == user_id && op[i].visa == null ){
				...
				'<span><a class="btn btn-primary"   href="javascript:void(0)" onclick="penalite('+op[i].id_eng+','+op[i].p_id+')">عقوبة تأخير</a></span>'+
				'</td>';	
			}
