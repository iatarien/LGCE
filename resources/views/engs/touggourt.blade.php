...
<section style="background-color: white; text-align: center; font-size: {{$font}}; margin: 20px;" id="fiche">
	<div id="fiche_top">
		...
		<div dir="rtl" style="float: right; text-align : right; width : 100%;">
			...
			@if($ville_fr =="Touggourt")
			<h3 dir="ltr" style="width : 100%;"><span>{{$eng->intitule}}<span>   </h3>
			@endif
			</div>
		...
		<table id="engagement" contenteditable="true" >
			...
			@if($insc == "lol" )
				@foreach($titres2 as $titre)
					...
					<tr style='font-weight : 900;'>	
                        ...
                        <td dir="rtl" colspan="2">{{$titre->definition}}</td>
                        @else
                        <td dir="rtl">{{$titre->code." "}}</td>
                        <td dir="rtl">الصنف</td>
					...
					@else
                        ...
                        <tr>	
                            ...
                            <td dir="rtl">{{$reb->code}}</td>
                            @if($i == 1)
							<td rowspan ="2" dir="rtl">الصنف الفرعي</td>
                            @endif
						</tr>
						@endif
					@endif
			...
			<tr style='font-weight : 900;'>	
				...
				<td colspan="2" dir="rtl">المجموع</td>
			</tr>
			@else
			<tr style='font-weight : 900;'>	
				<td>{{ number_format((float)$tots->montant_2, 2, '.', ' ')}}</td>
