	          ...
	          <div class="form quick-post">
                ...
                <div class="form-group row">
                  <label class="control-label col-sm-2" style="text-align : right; font-weight: bold; color : red;" for="title"> سحب بطاقة</label>
	                <div class="col-sm-9">
	                  <input onkeyup="subject()" dir="rtl" style="text-align : right" required=""  type="text" class="form-control" id="retrait">
	                </div>
                  </div><br>
                @endif
                ...
                <div class="form-group row">
                  <label class="control-label col-sm-2" style="text-align : right; font-weight: bold;" for="title">رقم العملية</label>
	                <div class="col-sm-9">
                    <input id="op_input" dir="ltr" style="text-align : right;" list="ops" class="form-control" id="numero_op_txt" onclick="op_like(this.value)" onkeyup="op_like(this.value)" > 
                ...
                <div class="form-group row">
                  <label class="control-label col-sm-2" style="text-align : right; font-weight: bold;" for="title">رقم البطاقة</label>
	                <div class="col-sm-9">
	                  <input dir="ltr" style="text-align : right" required=""  type="text" class="form-control" id="numero_fiche" name="numero_fiche">
	                </div>
                </div><br>
                @if($type=="eng")
                <div class="form-group row">
...
<script type="text/javascript">
  window.onload = function(){
    @if(isset($deal))
      //document.getElementById('loading').style.display = "none";
      ops_changed('{{ $deal->id_op }}1989raouf1989{{$deal->intitule_ar}}1989raouf1989{{$deal->numero}}');
    @else
      document.getElementById('loading').style.display = "none";
    @endif
