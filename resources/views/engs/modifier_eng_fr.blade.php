	      ...
	      <div class="panel-body">
	        <div class="padd">
	          ...
	          <div class="form quick-post">
                ...
                <div class="form-group">
                    <label  class="control-label col-sm-2" style="text-align : left; font-weight: bold;" for="title">Intitule de l'opération</label>
	                <div class="col-sm-9">
                ...
                @endif
                <div class="form-group">
                  <label class="control-label col-sm-2" style="text-align : left; font-weight: bold;" for="title">Objet d'engagement</label>
	                <div class="col-sm-9">
            ...
            <br>
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" style="text-align : left; font-weight: bold;" for="title">Numéro Visa  </label>
                <div class="col-sm-9">
                  <input name="num_visa" value="{{$eng->num_visa}}" type="text" class="form-control" id="numero" name="num_visa">
                </div>
              </div><br>
              <div class="form-group">
                <label class="control-label col-sm-2" style="text-align : left; font-weight: bold;" for="title">Date Visa </label>
                <div class="col-sm-9">
	              ...
	              <div class="form-group" align="center">
	                ...
	                <div class="col-sm-offset-2 col-sm-9">
	                  <button type="submit" class="btn btn-primary">Sauevgarder</button>
	                </div>
	              </div>
	            </form>
	          </div>
